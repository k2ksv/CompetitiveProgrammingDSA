...
void solve(){
    ...
    long long ansa = (d/a) * 6 - (d/lcm(a, b)) * 3 - (d/lcm(a, c)) * 3 + (d/lcm(a, lcm(b, c))) * 2;
    long long ansb = (d/b) * 6 - (d/lcm(b, a)) * 3 - (d/lcm(b, c)) * 3 + (d/lcm(a, lcm(b, c))) * 2;
    long long ansc = (d/c) * 6 - (d/lcm(c, b)) * 3 - (d/lcm(c, a)) * 3 + (d/lcm(a, lcm(b, c))) * 2;
